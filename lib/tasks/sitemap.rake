...
namespace :sitemap do
  ...
  def submit_to_google
    ...
    site_url = ENV.fetch('GOOGLE_SEARCH_CONSOLE_SITE_URL', nil)
    credentials_path = ENV.fetch('GOOGLE_SEARCH_CONSOLE_CREDENTIALS', nil)
  ...
  def get_google_access_token(_credentials)
